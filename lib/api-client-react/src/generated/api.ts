...
export const getResumeMirrorJobUrl = (id: string,) => {




  return `/api/mirror-jobs/${id}/resume`
}

/**
 * @summary Resume unfinished work for a cancelled or failed mirror
 */
export const resumeMirrorJob = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<MirrorJob> => {

  return customFetch<MirrorJob>(getResumeMirrorJobUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getResumeMirrorJobMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resumeMirrorJob>>, TError,ResumeMirrorJobMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resumeMirrorJob>>, ResumeMirrorJobMutationVariables> = (props) => {
          const {id} = props ?? {};

          return  resumeMirrorJob(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ResumeMirrorJobMutationResult = NonNullable<Awaited<ReturnType<typeof resumeMirrorJob>>>

    export type ResumeMirrorJobMutationError = ErrorType<ErrorResponse>
    export type ResumeMirrorJobMutationVariables = {id: string}

    /**
 * @summary Resume unfinished work for a cancelled or failed mirror
 */
export const useResumeMirrorJob = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resumeMirrorJob>>, TError,ResumeMirrorJobMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof resumeMirrorJob>>,
        TError,
        ResumeMirrorJobMutationVariables,
        TContext
      > => {
      return useMutation(getResumeMirrorJobMutationOptions(options));
    }

export const getStreamMirrorJobEventsUrl = (id: string,) => {




  return `/api/mirror-jobs/${id}/events`
}

/**
 * @summary Stream live mirror progress snapshots
 */
export const streamMirrorJobEvents = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<string> => {

  return customFetch<string>(getStreamMirrorJobEventsUrl(id),
  {
    ...options,
    method: 'GET'
...
export const getStreamMirrorJobEventsQueryKey = (id: string,) => {
    return [
    `/api/mirror-jobs/${id}/events`
    ] as const;
    }


export const getStreamMirrorJobEventsQueryOptions = <TData = Awaited<ReturnType<typeof streamMirrorJobEvents>>, TError = ErrorType<ErrorResponse>>(id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof streamMirrorJobEvents>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getStreamMirrorJobEventsQueryKey(id);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof streamMirrorJobEvents>>> = ({ signal }) => streamMirrorJobEvents(id, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof streamMirrorJobEvents>>, TError, TData> & { queryKey: QueryKey }
}

export type StreamMirrorJobEventsQueryResult = NonNullable<Awaited<ReturnType<typeof streamMirrorJobEvents>>>
export type StreamMirrorJobEventsQueryError = ErrorType<ErrorResponse>
...
export function useStreamMirrorJobEvents<TData = Awaited<ReturnType<typeof streamMirrorJobEvents>>, TError = ErrorType<ErrorResponse>>(
 id: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof streamMirrorJobEvents>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getStreamMirrorJobEventsQueryOptions(id,options)
